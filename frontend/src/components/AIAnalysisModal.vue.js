...
const startAnalysis = async () => {
    ...
    try {
        ...
        const res = await analyzeStock(props.stockCode, props.type, config.value.provider, config.value.apiKey, config.value.model, props.type === 'precise' ? analysisInputs : {});
...
if (__VLS_ctx.visible) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...{ class: "flex justify-between items-center p-5 border-b border-gray-700 bg-gray-800" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
    ...
    if (!__VLS_ctx.hasConfig) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsics.h4, __VLS_intrinsics.h4)({
            ...{ class: "text-lg font-medium text-blue-400 mb-4 flex items-center" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: "w-1 h-6 bg-blue-500 mr-2 rounded-full" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsics.div, __VLS_intrinsics.div)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsics.h4, __VLS_intrinsics.h4)({
            ...{ class: "text-lg font-medium text-purple-400 mb-4 flex items-center" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsics.span, __VLS_intrinsics.span)({
            ...{ class: "w-1 h-6 bg-purple-500 mr-2 rounded-full" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsics.label, __VLS_intrinsics.label)({
            ...{ class: "block text-sm font-medium text-gray-400 mb-2" },
        });
        ...
        __VLS_asFunctionalElement(__VLS_intrinsics.button, __VLS_intrinsics.button)({
            ...
            ...{ class: "px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 rounded-lg text-white font-bold shadow-lg transform hover:-translate-y-0.5 transition-all" },
        });
        // @ts-ignore
        [startAnalysis,];
    }
        ...
        __VLS_asFunctionalElement(__VLS_intrinsics.h4, __VLS_intrinsics.h4)({
            ...{ class: "text-2xl font-light text-white mb-2" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsics.p, __VLS_intrinsics.p)({
            ...{ class: "text-blue-300/70 animate-pulse" },
        });
...
/** @type {__VLS_StyleScopedClasses['text-white']} */ ;
/** @type {__VLS_StyleScopedClasses['mb-2']} */ ;
/** @type {__VLS_StyleScopedClasses['text-blue-300/70']} */ ;
